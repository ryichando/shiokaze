...
**	Created by Ryoichi Ando <rand@nii.ac.jp> on Aug 28, 2017. 
**
**	Shiokaze (public) is free software; you can redistribute it and/or modify
**	it under the terms of the GNU General Public License Version 3
**	as published by the Free Software Foundation.
**
**	Shiokaze (public) is distributed in the hope that it will be useful,
